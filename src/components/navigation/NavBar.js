                            ...
                            {(toggleShow) => (
                                <Card style={{marginTop: '14px', width: '160px'}}>
                                    <ListGroup style={{width:'130px', background: "white"}}>
                                        <NavLink style={{paddingLeft: '10px'}} to="/shop?brand=1" className="link" target='_parent'>ANNE KLEIN</NavLink>
                                        <NavLink style={{paddingLeft: '10px'}} to="/shop?brand=2" className="link" target='_parent'>CALVIN KLEIN</NavLink>
                                        ...
                                        <NavLink style={{paddingLeft: '10px'}} to="/shop?brand=5" className="link" target='_parent'>LAMY</NavLink>
                                        <NavLink style={{paddingLeft: '10px'}} to="/shop?brand=6" className="link" target='_parent'>ORIENT</NavLink>
                                        <NavLink style={{paddingLeft: '10px'}} to="/shop?brand=7" className="link" target='_parent'>PARKER</NavLink>
                                        <NavLink style={{paddingLeft: '10px'}} to="/shop?brand=8" className="link" target='_parent'>SWATCH</NavLink>
                                        <NavLink style={{paddingLeft: '10px'}} to="/shop?brand=9" className="link" target='_parent'>VICTORINOX</NavLink>
                                        <NavLink style={{paddingLeft: '10px'}} to="/shop?brand=10" className="link" target='_parent'>WATERMAN</NavLink>
                                    </ListGroup>
                                </Card>
                            )}
                        </UIDropdown>
