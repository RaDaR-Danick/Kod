...
import { fetchOneProduct, updateProduct, fetchCategories, fetchBrands, fetchMehanizms, fetchGenders, fetchShapes, fetchMaterials, fetchGlasses, fetchStraps, fetchPowers, fetchWaters } from '../http/catalogAPI.js'  
...
const defaultValue = {name: '', price: '', category: '', brand: '', mehanizm: '', gender: '', shape: '', material: '', glass: '', strap: '', power: '', water: ''}
const defaultValid = {name: null, price: null, category: null, brand: null, mehanizm: null, gender: null, shape: null, material: null, glass: null, strap: null, power: null, water: null}
...
const UpdateProduct = (props) => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (correct.name && correct.price && correct.category && correct.brand && correct.mehanizm && correct.gender && correct.shape && correct.material && correct.glass && correct.strap && correct.power && correct.water) {
